...
public class RequestCloud {
    ...
    public static void main(String[] args) {
        ...
        params.put("idCard", "421181199306098711");
        params.put("mobile", "17612183965");
        String param = JSONObject.fromObject(params).toString();
        String s1 = RequestCloud.sendPost("https://api.dsdatas.com/blackData/fireEyesBlackv2", param,token);
